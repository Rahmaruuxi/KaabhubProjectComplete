...
const OpportunityDetail = () => {
  ...
  const fetchOpportunity = async () => {
    try {
      ...
      setError(err.response?.data?.message || 'Failed to fetch opportunity details');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <button
        ...
        className="inline-flex items-center text-sm text-gray-600 hover:text-[#136269] mb-6"
      >
      ...
      <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-[#5DB2B3]">
        <div className="p-6">
          <div className="flex items-start justify-between mb-6">
            ...
            {user && user._id === opportunity.author && (
              <div className="flex items-center space-x-2">
                <button
                  onClick={() => navigate(`/edit-opportunity/${id}`)}
                  className="p-2 text-gray-600 hover:text-[#136269] transition-colors duration-200"
                >
          ...
          <div className="prose max-w-none">
            ...
            {opportunity.benefits && (
              <>
                <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Benefits</h2>
                <p className="text-gray-600 whitespace-pre-wrap">{opportunity.benefits}</p>
              </>
            )}
          </div>
            ...
            <div className="space-y-4">
              ...
              {opportunity.contactEmail && (
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <a href={`mailto:${opportunity.contactEmail}`} className="hover:text-[#136269]">
                    {opportunity.contactEmail}
                  </a>
                </div>
              )}
              ...
              {opportunity.contactPhone && (
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <a href={`tel:${opportunity.contactPhone}`} className="hover:text-[#136269]">
                    {opportunity.contactPhone}
                  </a>
                </div>
              )}
              ...
              {opportunity.website && (
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <a href={opportunity.website} target="_blank" rel="noopener noreferrer" className="hover:text-[#136269]">
                    {opportunity.website}
                  </a>
                </div>
              )}
