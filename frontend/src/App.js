        ...
        <Router>
          <div className="min-h-screen bg-gray-50">
            ...
            <Routes>
              ...
              <Route path="/create-opportunity" element={<PrivateRoute><CreateOpportunity /></PrivateRoute>} />
              <Route path="/opportunity/:id" element={<OpportunityDetail />} />
              <Route path="/mentorships" element={<Mentorships />} />
              <Route path="/create-mentorship" element={<PrivateRoute><CreateMentorship /></PrivateRoute>} />
              <Route path="/edit-mentorship/:id" element={<PrivateRoute><EditMentorship /></PrivateRoute>} />
              ...
              <Route path="/edit-scholarship/:id" element={<ScholarshipForm />} />
            </Routes>
            <ChatWidget />
          </div>
        </Router>
